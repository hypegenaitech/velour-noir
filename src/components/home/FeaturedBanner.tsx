  ...
  return (
    <section className="relative w-full overflow-hidden group" style={{ height: '70vh' }}>
      ...
      <div className="absolute bottom-12 left-12 z-10">
        <p className="font-cormorant text-[48px] text-white uppercase tracking-[0.05em] leading-tight mb-2">
          THE GILDED NIRVANA<br />COLLECTION
        </p>
        <p className="font-cormorant italic text-gold text-xl mb-6">Discover the new standard of luxury</p>
